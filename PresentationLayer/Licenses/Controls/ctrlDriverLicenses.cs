...
namespace PresentationLayer.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            _dtDriverLocalLicensesHistory = clsDriver.GetAllLocalLicenses(_DriverID);
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            _dtDriverInternationalLicensesHistory = clsDriver.GetAllInternationalLicenses(_DriverID);
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("Error:No Driver is found", "Error",
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("Error:No Driver is linked with PersonID:" + PersonID.ToString(), "Error",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
